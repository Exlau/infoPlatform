        ...
        <div class="VideoPortal-navBar">
          ...
          <div class="ms-NavBar">
            ...
            <ul class="ms-NavBar-items">
              ...
              <li class="ms-NavBar-item is-selected">
                <a class="ms-NavBar-link" href="index.html">Home</a>
              </li>
              <li class="ms-NavBar-item">
                <a class="ms-NavBar-link" href="channels.html">All Channels</a>
              </li>
              <li class="ms-NavBar-item ms-NavBar-item--hasMenu">
                <a class="ms-NavBar-link" href="#">My Channels</a>
                <i
                  class="ms-NavBar-chevronDown ms-Icon ms-Icon--chevronDown"
                ></i>
                <ul class="ms-ContextualMenu">
                  <li class="ms-ContextualMenu-item">
                    <a class="ms-ContextualMenu-link" href="#"
                      >Employee interviews</a
                    >
                  </li>
                  <li class="ms-ContextualMenu-item">
                    <a class="ms-ContextualMenu-link" href="#"
                      >Executive Briefings</a
                    >
                  </li>
                  <li class="ms-ContextualMenu-item">
                    <a class="ms-ContextualMenu-link" href="#"
              ...
              <div class="ChannelList">
                ...
                <div class="ChannelList-item">
                  <h3 class="ChannelList-title" style="border-color: #dc0606">
                    <span class="ChannelList-titleText ms-font-xl">Popular</span
                    ><span
                      class="
                        ms-font-l
...
.ms-Breadcrumb-list
  .ms-Breadcrumb-listItem:last-of-type
  .ms-Breadcrumb-chevron {
  display: none;
}
...
.ms-Button-label {
  color: #333333;
  font-family: "Segoe UI Semibold WestEuropean", "Segoe UI Semibold", "Segoe UI",
    Tahoma, Arial, sans-serif;
  font-size: 14px;
}
...
.ms-CommandBarSearch.is-active.ms-CommandBarSearch--hasBack
  .ms-CommandBarSearch-input {
...
.ms-ContextualMenu.ms-ContextualMenu--multiselect
  .ms-ContextualMenu-link.is-selected:after {
  -moz-osx-font-smoothing: grayscale;
  -webkit-font-smoothing: antialiased;
  display: inline-block;
  font-family: "Office365Icons";
...
.ms-Panel.ms-Panel--animatedCommands
  .ms-CommandBarItem:first-child:hover
  .ms-CommandBarItem-icon {
  color: #ffffff;
}
...
.ms-PeoplePicker.ms-PeoplePicker--Facepile.is-searching
  .ms-PeoplePicker-results {
  border-bottom: 0;
  padding: 20px 0 0;
}
...
.ms-PeoplePicker.ms-PeoplePicker--Facepile
  .ms-PeoplePicker-searchMore.is-active {
  display: block;
}
...
.ms-Pivot.ms-Pivot--tabs
  .ms-Pivot-link:hover:not(.is-selected):not(.ms-Pivot-link--overflow),
.ms-Pivot.ms-Pivot--tabs
  .ms-Pivot-link:focus:not(.is-selected):not(.ms-Pivot-link--overflow) {
  color: #000000;
}
